...
from river.tree.nodes.efdtc_nodes import (
    BaseEFDTBranch,
    ...
    def _reevaluate_best_split(self, node, parent, branch_index, **kwargs):
        ...
        if not node.observed_class_distribution_is_pure():
            ...
            if len(best_split_suggestions) > 0:
                ...
                elif (  # TODO nuovo crash perchè x_current è None (aggiunto x_current is not None and)
                    x_current is not None and x_best.merit - x_current.merit > hoeffding_bound
